      ...
      <b-row align-h="between" class="pb-2">
        ...
        <b-col md="5" sm="5" cols="7">
          <b-row v-if="!isFinalStep">
            ...
            <b-col md="8" sm="8" cols="6" class="pr-0 pl-0">
            ...
            <b-col md="1" sm="1" cols="2" class="pr-0 pl-0 ml-2">
